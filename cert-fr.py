...
ascii = pyfiglet.figlet_format("Script du " )
cert = pyfiglet.figlet_format("CERT-FR ")
...
def creation_excel(data, file, main_sheet, source_column, destination_column):
    ...
    for cve_list in src:
        ...
        numero_ligne += 1
        #print(numero_ligne)
        print(reference, names, "numéro de ligne ->", numero_ligne) 
